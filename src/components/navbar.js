...
const Navbar = () => {
  ...
  return (
    <div className='bg-secundaria h-[100px] flex justify-between px-4 items-center'>
        ...
        <ul className='hidden md:flex text-white gap-8 items-center h-full'>
            ...
            <li className='hover:scale-110'><a href='#'>Descrição</a></li>
            <li className='hover:scale-110'><a href='#'>Produto</a></li>
        </ul>
